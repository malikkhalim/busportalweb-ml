...
def q_learning(start_state=3, num_epoch=200, gamma=0.8, epsilon=0.05, alpha=0.1, visualize=True, save_video=True):
    print("-" * 20)
    ...
    if visualize and save_video:
        ...
        imageio.mimsave("static/images/q-learning.gif", imgs, fps=5)  # generate video/gif out of list of images
...
if __name__ == '__main__':
    ...
    bus_service_numbers = sys.argv[1].split(',')
    current_location_postal = sys.argv[2]
    destination_postal = sys.argv[3]
    
    print(bus_service_numbers, current_location_postal, destination_postal)
    
    # best_route_info = q_learning(bus_service_numbers, current_location_postal, destination_postal)
    # print("Best route information:", best_route_info)
    ...
    # # Show plot
    # plt.show()
    best_route_info = q_learning(start_state=start_state, num_epoch=num_epoch, gamma=0.8, epsilon=0.05, alpha=0.1, visualize=True, save_video=True)